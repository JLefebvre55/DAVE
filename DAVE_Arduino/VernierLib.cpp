...
void VernierLib::autoID()
{
  ...
  _sensorName[16];
  temp1.toCharArray(_sensorName, 16) ; // I am using 16 characters here, plus terminator.
  temp1 = "sh0rtName   ";
  _shortName[12];//12 characters on name, plus terminator.
  temp1.toCharArray(_shortName, 12);
  temp1 = "Units  ";
  _sensorUnits[7];//7 characters units, plus terminator.
  temp1.toCharArray(_sensorUnits, 7);
